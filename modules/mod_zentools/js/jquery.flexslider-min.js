  ...
  jQuery.flexslider = function(el, options) {
    ...
    slider.init = function() {
      ...
      if (slider.vars.directionNav) {
        var directionNavScaffold = jQuery('<ul class="flex-direction-nav"><li><a class="prev" href="#"><span>' + slider.vars.prevText + '</span></a></li><li><a class="next" href="#"><span>' + slider.vars.nextText + '</span></a></li></ul>');
